...
;
const metadata = {
    title: "ChillPill - Smart Cooling Coordination",
    description: "AI-powered cooling coordination system for HDB blocks in Singapore. Turning cooling from an individual decision into a collective, intelligent system."
};
