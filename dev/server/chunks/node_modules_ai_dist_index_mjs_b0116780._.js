...
function getGlobalProvider() {
    var _a20;
    return (_a20 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a20 : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$gateway$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gateway"];
}
...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "6.0.58" : "TURBOPACK unreachable";
...
async function recordSpan({ name: name20, tracer, attributes, fn, endWhenDone = true }) {
    return tracer.startActiveSpan(name20, {
...
function addLanguageModelUsage(usage1, usage2) {
    ...
    return {
        ...
        inputTokenDetails: {
            noCacheTokens: addTokenCounts((_a20 = usage1.inputTokenDetails) == null ? void 0 : _a20.noCacheTokens, (_b = usage2.inputTokenDetails) == null ? void 0 : _b.noCacheTokens),
...
function hasToolCall(toolName) {
    return ({ steps })=>{
        var _a20, _b, _c;
        return (_c = (_b = (_a20 = steps[steps.length - 1]) == null ? void 0 : _a20.toolCalls) == null ? void 0 : _b.some((toolCall)=>toolCall.toolName === toolName)) != null ? _c : false;
    };
}
                    ...
                    modelMessages.push({
                        ...
                        content: message.parts.map((part)=>{
                            ...
                            if (isDataUIPart(part)) {
                                return (_a20 = options == null ? void 0 : options.convertDataPart) == null ? void 0 : _a20.call(options, part);
                            }
            ...
            const { embedding, usage, warnings, response, providerMetadata } = await retry(()=>// nested spans to align with the embedMany telemetry data:
                recordSpan({
                    ...
                    fn: async (doEmbedSpan)=>{
                        ...
                        const usage2 = (_a20 = modelResponse.usage) != null ? _a20 : {
                            tokens: NaN
                        };
                    ...
                    return retry(()=>{
                        return recordSpan({
                            ...
                            fn: async (doEmbedSpan)=>{
                                ...
                                const usage = (_a21 = modelResponse.usage) != null ? _a21 : {
                                    tokens: NaN
                                };
                                doEmbedSpan.setAttributes(await selectTelemetryAttributes({
                                    telemetry,
...
function simulateReadableStream({ chunks, initialDelayInMs = 0, chunkDelayInMs = 0, _internal }) {
    var _a20;
    const delay2 = (_a20 = _internal == null ? void 0 : _internal.delay) != null ? _a20 : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["delay"];
    let index = 0;
    return new ReadableStream({
        async pull (controller) {
...
var doWrap = ({ model, middleware: { transformParams, wrapGenerate, wrapStream, overrideProvider, overrideModelId, overrideSupportedUrls }, modelId, providerId })=>{
    ...
    return {
        specificationVersion: "v3",
        provider: (_a20 = providerId != null ? providerId : overrideProvider == null ? void 0 : overrideProvider({
            model
        })) != null ? _a20 : model.provider,
...
var doWrap3 = ({ model, middleware: { transformParams, wrapGenerate, overrideProvider, overrideModelId, overrideMaxImagesPerCall }, modelId, providerId })=>{
    ...
    const maxImagesPerCallRaw = (_a20 = overrideMaxImagesPerCall == null ? void 0 : overrideMaxImagesPerCall({
        model
    })) != null ? _a20 : model.maxImagesPerCall;
...
var DefaultProviderRegistry = class {
    ...
    languageModel(id) {
        ...
        let model = (_b = (_a20 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b.call(_a20, modelId);
        if (model == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NoSuchModelError"]({
                modelId: id,
                modelType: "languageModel"
...
async function callCompletionApi({ api, prompt, credentials, headers, body, streamProtocol = "data", setCompletion, setLoading, setError, setAbortController, onFinish, onError, fetch: fetch2 = getOriginalFetch() }) {
    ...
    try {
        ...
        if (!response.ok) {
            throw new Error((_a20 = await response.text()) != null ? _a20 : "Failed to fetch the chat response.");
        }
        if (!response.body) {
...
var AbstractChat = class {
     ...
     */ this.clearError = ()=>{
        ...
        this.addToolApprovalResponse = async ({ id, approved, reason })=>this.jobExecutor.run(async ()=>{
                ...
                if (this.status !== "streaming" && this.status !== "submitted" && ((_a20 = this.sendAutomaticallyWhen) == null ? void 0 : _a20.call(this, {
